...
// SIMPLE WORKING EMAIL lead submission
...
app.get('/health', (req, res) => {
    res.json({
        ...
        port: PORT,
        message: 'Simple working email system is ready!'
    });
});

// Start server
app.listen(PORT, () => {
    console.log('🚀 The Storm Professional Simple Working Email Server is running!');
