...
// WORKING SIMPLE EMAIL lead submission
...
app.get('/health', (req, res) => {
    res.json({
        ...
        port: PORT,
        message: 'Working simple email system is ready!'
    });
});

// Start server
app.listen(PORT, () => {
    console.log('🚀 The Storm Professional Working Simple Email Server is running!');
